    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="Food-fair-toggle">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="{{ route('login') }}"><i class="fa fa-sign-in fa-stack-1x"></i></a></li>
                <li><a href="{{ route('register') }}"><i class="fa fa-user-plus fa-stack-1x"></i></a></li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </div><!-- /.row -->
</nav>
...
<section id="header-slider" class="owl-carousel">
    ...
    @else
        <div class="item">
            <div class="container">
                <div class="header-content">
                    <h1 class="header-title">Best Foods</h1>
                    <p class="header-sub-title">Create your slogan.</p>
                </div> <!-- /.header-content -->
            </div>
        </div>
    @endif
                            ...
                            <div class="section-header">
                                ...
                                <ul id="filter-list" class="clearfix">
                                    ...
                                    @foreach($categories as $category)
                                        <li class="filter text-capitalize" data-filter="#{{$category->slug}}">{{$category->name}} <span class="badge">{{$category->items->count()}}</span></li>
                                    @endforeach
                                </ul><!-- @end #filter-list -->
                            </div>
                        </div>
